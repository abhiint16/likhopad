 ...
 */
public abstract class AbstractGetNameTask extends AsyncTask<String,String,String> {

    private static final String TAG = "TokenInfoTask";
    protected Register mActivity;
    ...
    AbstractGetNameTask(Register activity, String email, String scope) {
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        Log.d("token","aaaaaaaaaaaaaaa"+token);
        Log.d("token","aaaaaaaaaaaaaaa"+token);
        Log.d("token","aaaaaaaaaaaaaaa"+token);
        Log.d("token","aaaaaaaaaaaaaaa"+token);
        Log.d("token","aaaaaaaaaaaaaaa"+token);
